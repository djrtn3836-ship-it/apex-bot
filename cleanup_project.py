...
print(f"\n✅ 정리 완료: {ARCHIVE} 폴더에 보관됨")
print("⚠️  봇 재시작 후 오류 없으면 _archive 폴더 최종 삭제 가능")
