# fix_final.py
"""FIX-1: cache_manager.py  get_ohlcv  → self._npy_cache  + REST fallback
FIX-2: engine.py _main_loop →  9   _analyze_existing_position"""
...
if "    def get_stats(self)" in cleaned:
    ...
    print(" FIX-1: get_ohlcv    (_npy_cache )")
else:
    cleaned += "\n" + NEW_WRAPPER
...
if "_analyze_existing_position" not in loop_body:
    print("  _main_loop _analyze_existing_position   → ")
